...
class UrlManagerComponent extends \yii\web\UrlManager
{
    ...
    public $rules = [
        ...
        '<action:checkout|my-cart|my-wishlist|my-account-details|signup-verification|customer-dashboard|signup-success|signup|shop|about|index|login|reset-password|contact|home>' => 'site/<action>',
