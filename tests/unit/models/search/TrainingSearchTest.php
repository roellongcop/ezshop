...
class TrainingSearchTest extends \Codeception\Test\Unit
{
    ...
    public function testSearchWithResult()
    {
        ...
        $dataProviders = $searchModel->search(['TrainingSearch' => ['keywords' => '']]);
    ...
    public function testSearchWithNoResult()
    {
        ...
        $dataProviders = $searchModel->search([
            'TrainingSearch' => ['keywords' => 'qwertyuiopasdfghjkl234567890']
        ]);
