...
class AboutUsForm extends SettingForm
{
    ...
    public function rules()
    {
        return [
            ...
            [['owner', 'shop_name', 'address', 'contact_no', 'information'], 'string'],
        ];
    }
    ...
    public function default()
    {
        return [
            ...
            'information' => [
                'name' => 'information',
                'default' => <<< HTML
                    <p class="lead font-weight-bold">Purpose of the Project System</p>
                    ...
                    <p></p>
                    <p class="lead font-weight-bold">Importance</p>
                    ...
                    <p></p>
                    <p class="lead font-weight-bold">Benefits of Development of intelligent e-commerce customer support services using NLP Algorithm</p>
                    <ul>
                        <li>Faster Buying</li>
